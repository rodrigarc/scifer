...
To use scifer, you should first install Bioconductor package manager.
...
Here is an example of a poor threshold using the size and forward scatter (cell size and granulosity).
